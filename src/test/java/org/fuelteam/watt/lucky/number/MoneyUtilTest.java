...
import org.fuelteam.watt.lucky.number.MoneyUtil;
...
public class MoneyUtilTest {
    ...
    public void amountConvertTest() {
        ...
        assertThat(MoneyUtil.fen2yuan("100").doubleValue()).isEqualTo(new BigDecimal(1.00d).doubleValue());
        assertThat(MoneyUtil.fen2yuan(BigDecimal.valueOf(100d)).doubleValue()).isEqualTo(new BigDecimal(1.00d).doubleValue());

        // 金额元转换成分
        assertThat(MoneyUtil.yuan2fen(BigDecimal.valueOf(1d)).doubleValue()).isEqualTo(new BigDecimal(100d).doubleValue());
