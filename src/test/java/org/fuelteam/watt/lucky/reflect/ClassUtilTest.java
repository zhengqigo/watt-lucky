...
import org.fuelteam.watt.lucky.reflect.AnnotationUtil;
...
public class ClassUtilTest {
    ...
    public void testIsSubClassOrInterfaceOf() {
        assertTrue("TestBean should be subclass of ParentBean", ClassUtil.isSubClassOrInterfaceOf(BClass.class, AClass.class));
