...
public class ThreadPoolBuilderTest {
    ...
    public void fixPool() {
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix = ThreadPoolBuilder.fixedPool().setPoolSize(10).setThreadNamePrefix("fixPool")
                .build();
    ...
    public void cachedPool() {
        ...
        ThreadPoolExecutor sizeablePool = ThreadPoolBuilder.cachedPool().setMinSize(10).setMaxSize(100).setKeepAliveSecs(20)
                .build();
