...
/**
 * StringBuilderWriter线程不安全但性能更好, 多线程使用java.io.StringWriter
 * 
 * @see https://github.com/apache/commons-io/blob/master/src/main/java/org/apache/commons/io/output/StringBuilderWriter.java
 */
public class StringBuilderWriter extends Writer implements Serializable {
	...
	/**
	 * Constructs a new instance with the specified {@link StringBuilder}, if {@code builder} is null a new instance with default capacity will be created
	 *
